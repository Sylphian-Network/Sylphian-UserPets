 ...
 * @property int|null $sylphian_userpets_experience_per_sleep XP per action sleep
 * @property int|null $sylphian_userpets_experience_per_thread XP Per Thread
 * @property int|null $sylphian_userpets_happiness_critical_threshold Happiness Critical Threshold
 * @property int|null $sylphian_userpets_happiness_decay Happiness Decay
